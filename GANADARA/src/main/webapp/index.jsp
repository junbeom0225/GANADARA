			...
			<nav id="menu">
				...
				<section id="banner" data-video="resources/img/assets">
					<div class="inner">
						<div id="h">
							<h1>가나다라</h1>
							<p>Hello. Welcome to GANADARA Korean Education Institute...  <br />
							어서오세요. 가나다라 한국어 학습원입니다. 한국어 강의와 단어, 말하기, 타자연습을 통해 실력을 키우세요.</p>
						</div>
				...
				<div id="main">
					...
					<!-- Boxes -->
						<div class="thumbnails">
							...
							<div class="box">
								<a href="videostudy.do" class="image fit"><img src="resources/img/assets/korean.png" alt="" /></a>
								<div class="inner">
									<h3>한국어 학습</h3>
									<p>단계별 한국어 강의를 통해 한국어 기초를 다지고 단어학습, 말하기연습을 통해 실력을 향상합니다. </p>
									<a href="videostudy.do" class="button fit">학습하러 가기</a>
								</div>
							</div>

							<div class="box">
								<a href="" class="image fit"><img src="resources/img/assets/writing3.png" alt="" /></a>
								<div class="inner">
									<h3>글쓰기 첨삭</h3>
							...
							<div class="box">
								<a href="" class="image fit"><img src="resources/img/assets/typing.png" alt="" /></a>
								<div class="inner">
									<h3>타자연습</h3>
							...
							<div class="box">
								<a href="" class="image fit"><img src="resources/img/assets/mypage.png" alt="" /></a>
								<div class="inner">
									<h3>마이페이지</h3>
			...
			<!-- Footer -->
				<footer id="footer">
					<div class="inner">
						...
						<p>가나다라 한국어 학습은 최희선, 황다혜, 최소연, 황다혜, 박준범, 박건웅을 도움으로 제작되었습니다만, 제작물 중 저작권은..아무것도 우리에게 없어요. 파이널 도대체 언제 끝날까요. 메리크리스마스...  </p>
