...
<input type="text" id="level">
 ...
 // 팝업창 가운데로 위치지정해줄 값
	...
	var chlidwindow = window.open('keypop.do','GAMELEVEL','width=400, height=400, left ='+popleft+',top='+poptop);
	
 // 내려오게 할 단어의 목록을 배열로 선언하였습니다.
    var taja = ["자바", "파이썬", "몽고디비", "고구마", "사과", "바나나", "경복궁", "제이쿼리", "스프링", "스프링부트",
        "자바스크립트", "오라클디비", "마이에스큐엘", "톰캣", "이클립스", "마이바티스", "포도", "아메리카노", "바닐라라떼", "헤이즐럿아메리카노"
    ];
 // Div를 넣어주게 됩니다. 
    var tajaContents = document.getElementById("tajaContents");
    // 밑에 선언한 tajaContents 안에 글자로 된
