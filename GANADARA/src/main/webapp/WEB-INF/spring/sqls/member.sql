...
UPDATE MEMBER SET MEMBER_PW = 'gggg' WHERE MEMBER_EMAIL = 'ggg@gggg.com';
...
values(memberseq.nextval, 'user13', 'RABIT', 'MMa@aMMa.com', 'user13', '010-0666-0660', 
       ...
       insert into member
values(memberseq.nextval, 'user24', '吏�', 'a@QQ.com', 'user24', '010-6363-3636', 
...
values(memberseq.nextval, 'user16', 'ido', 'QQa@QQ.com', 'user16', '010-6060-0606', 
       ...
       insert into member
values(memberseq.nextval, 'user25', '�씠', 'hha@QQ.com', 'user26', '010-6566-5676', 
...
insert into member
values(memberseq.nextval, 'user30', '�븯�븯', 'ythfeeha@QQ.com', 'user30', '010-2561-3711', 
       '19671228', 'ASIA', SYSDATE, 'N', 'USER', 'N', NULL, 'Y')
insert into member
values(memberseq.nextval, 'user31', '�샇�샇', 'hfeeha@QQ.com', 'user31', '010-2456-3715', 
       '19981228', 'ASIA', SYSDATE, 'N', 'USER', 'N', NULL, 'Y')       
insert into member
values(memberseq.nextval, 'user32', '吏깆씠3', 'hfeeha@QQ.com', 'user32', '010-2746-3115', 
       '19931228', 'ASIA', SYSDATE, 'N', 'USER', 'N', NULL, 'Y')
insert into member
values(memberseq.nextval, 'user33', '踰좎㎟�씠', 'huwea@QQ.com', 'user33', '010-5246-5315', 
...
insert into member
values(memberseq.nextval, 'user38', '�뤌吏�', 'h12fheha@QQ.com', 'user38', '010-2156-1715', 
       '2003128', 'ASIA', SYSDATE, 'N', 'USER', 'N', NULL, 'Y')
insert into member
values(memberseq.nextval, 'user39', '袁몄쭏�씠', 'yeeha@QQ.com', 'user39', '010-2346-7895', 
       '19501228', 'ASIA', SYSDATE, 'N', 'USER', 'N', NULL, 'Y')
insert into member
values(memberseq.nextval, 'user40', '�븿留�', 'yreha@QQ.com', 'user40', '010-2400-3707', 
