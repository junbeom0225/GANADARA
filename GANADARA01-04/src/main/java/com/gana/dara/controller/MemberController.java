...
public class MemberController {
	...
	*/
	...
	// 아이디 찾기
		...
		@ResponseBody
		public MemberDto userIdSearch(@RequestParam("member_name") String member_name, 
				@RequestParam("member_tel") String member_tel) {
			
			MemberDto dto = new MemberDto();
			
			MemberDto res = biz.get_searchId(dto);
			String member_email = res.getMember_email();
			
			System.out.println(member_email + "아이디");
			System.out.println(res);
			System.out.println(member_name);
			
			Map<String, String> map = new HashMap<String, String>();
			map.put("check", member_name);
			map.put("check", member_tel);
